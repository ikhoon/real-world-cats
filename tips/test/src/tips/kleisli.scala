...
/**
  ...
  */
object KleisliTest extends TestSuite {
    ...
    'kleisli {
      ...
      'compose_with_effect {
        ...
        /**
          ...
          */
        //                               String     ==>     Boolean
        val kleisli: Kleisli[Option, Int, Boolean] =
          Kleisli[Option, Int, String](f).andThen(g)
        ...
        val cc: Kleisli[Option, AccountRepository, Boolean] =
          foo(10).flatMap(bar)
